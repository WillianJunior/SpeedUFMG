...
Perguntas respondidas mais frequentes. Já sabendo usar mais ou menos o cluster e tendo problemas, a primeira coisa que deve ser feita é ler esse FAQ.

## Meus códigos/dados estão em uma gorgona e não consigo mais acessá-los. O que eu faço para acessá-los?
...
## Eu não consigo acessar meus arquivos em /home_cerberus/speed/username, não tendo permissão. O diretório, assim como os arquivos aparecem com outro owner. O que devo fazer?
...
## O module python3.12.1 não está carregando, mostrando apenas o python3.10.
...
## Não estou conseguindo mais criar um venv na home_cerberus.
...
## ERROR: Could not install packedges due to an OSError: [Errorno 28] No space left on device
Use o comando 
...
## ERROR: Could not install packedges due to an OSError: [Errorno 13] Permission denied: '/home/pos/user' check the permissions
...
## A minha home não existe em algumas gorgonas.
...
## Submeti um job mas não aconteceu nada, nem saiu um arquivo slurm-id.out.
...
## Não estou conseguindo pullar do git.
